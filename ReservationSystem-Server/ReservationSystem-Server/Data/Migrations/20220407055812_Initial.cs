        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tables_RestaurantAreas_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "123 Main Street", "email@example.com", "Carefront", "0412345678" });
            ...
            migrationBuilder.InsertData(
                table: "Sittings",
                columns: new[] { "Id", "Capacity", "EndTime", "IsClosed", "RestaurantId", "SittingTypeId", "StartTime" },
                values: new object[,]
                {
                    { 1, 0, new DateTime(2022, 3, 31, 9, 0, 0, 0, DateTimeKind.Local), false, 1, 1, new DateTime(2022, 3, 31, 6, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 0, new DateTime(2022, 3, 31, 14, 0, 0, 0, DateTimeKind.Local), false, 1, 2, new DateTime(2022, 3, 31, 11, 0, 0, 0, DateTimeKind.Local) },
                    { 3, 0, new DateTime(2022, 3, 31, 21, 0, 0, 0, DateTimeKind.Local), false, 1, 3, new DateTime(2022, 3, 31, 17, 0, 0, 0, DateTimeKind.Local) }
                });

            migrationBuilder.InsertData(
                table: "Tables",
                columns: new[] { "Id", "AreaId", "Name", "Seats" },
                values: new object[,]
                {
                    { 2, 1, "M1", 4 },
                    { 3, 1, "M2", 4 },
