...
function submitForm(form) {
    ...
    // first ensure that sending a submit event will not actually submit the form and 
    form.on('submit', e => e.preventDefault());
    // then dispatch the submit event so that other listeners can handle the event
    form.get(0).dispatchEvent(new Event('submit'));
